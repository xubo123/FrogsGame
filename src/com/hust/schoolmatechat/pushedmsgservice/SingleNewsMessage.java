...
public class SingleNewsMessage {
	...
	public SingleNewsMessage(int nid, String icon, boolean isBreaking,
			String title, String summary, Date time, String newsUrl,
			String channelId, String pMId, String content) {
		super();
		this.nid = nid;
		this.icon = icon;
